...
<section class="main" id="banner">
	<div class="banner">
   		<img src="images/product/shoes/slide.jpg" alt="" />
	</div>
</section>   
<article class="main" style="margin-bottom:-1px;">
   	<div class="left_banner">
        ...
        <div class="text_left_menu" style="background:#fff;height:631px">
            ...
            <p class="by_shadow_bl" style="width:90px;margin-left:5px;margin-top:-7px;"></p>
            	<a href="shoes.php?muc=1&#show_sp"><li>&#149; Giày mọi<br /><span style="color:#fff">&#149;</span> Giày lười</li></a>
            	<a href="shoes.php?muc=7&#show_sp"><li>&#149; Giày tăng chiều cao</li></a>
            	<a href="shoes.php?muc=2&#show_sp"><li>&#149; Sneaker</li></a>
            	<a href="shoes.php?muc=3&#show_sp"><li>&#149; Giày Casual</li></a>
            	<a href="shoes.php?muc=5&#show_sp"><li>&#149; Giày cổ cao</li></a>
                <a href="shoes.php?muc=4&#show_sp"><li>&#149; Giày Tây</li></a>
                <a href="shoes.php?muc=6&#show_sp"><li>&#149; Giày thể thao</li></a>
                
			<p style="padding:10px 0 7px 10px;">CHỌN GIÁ</p>
            <p class="by_shadow_bl" style="width:90px;margin-left:5px;margin-top:-7px;"></p>
	            <?php if($_GET['muc'])$url='shoes.php?muc='.$_GET['muc'].'&gia='; else $url='?gia='?>
	...
	<section id="show_sp">
        ...
        <?php
			...
			$sql = "SELECT * FROM `sp` $dk ORDER BY `date` DESC LIMIT 0,16 ";
			$result = mysql_query($sql, $connection);
			while ($row = mysql_fetch_array($result)){?>
            <a href="chitiet.php?item=sp-<?php echo $row['id']?>"><div><img src="images/product/shoes/<?php echo $row['id']?>_1.jpg" alt="" /></div></a>
            <?php }?>
        </div>
   	</section>
    <div class="clr"></div>
    <section id="banner_body">
    	<div style="background:#0c7bdd;"><img src="images/product/shoes/banner_body.jpg" width="749" height="207"  alt="" /></div>
    </section>
   	<div class="left_banner">
        <div>
            <div style="position:absolute;"></div>
   	...
   	<section>
    	<div class="shoes" style="width:840px;">
		<?php
		    $sql = "SELECT * FROM `dem` WHERE `sp_pk` = 'sp' ORDER BY `sl` DESC LIMIT 0,16 ";
			$result = mysql_query($sql, $connection);
			while ($row = mysql_fetch_array($result)){?>
        <a href="chitiet.php?item=sp-<?php echo $row['ma_sp'] ?>"><div><img onerror="this.src='images/icon/error.jpg'"  src="images/product/shoes/<?php echo $row['ma_sp'] ?>_1.jpg" alt="" /></div></a>
        <?php }?>
        </div>
   	</section>
    <div class="clr"></div>
