...
<article class="main" style="margin-bottom:-1px;">
	...
	<section id="show_sp">
        ...
        <?php
            ...
            <div>
                <a href="chitiet.php?item=sp-<?php echo $row['id']?>">
                    <img src="images/product/shoes/<?php echo $row['id']?>_1.jpg" alt="<?php echo $row['ten'] ?>" title='<?php echo $row['ten'] ?>'/>
                    <span class="product-price"> <?php echo $row['dongia'] ?></span>
                </a>
            </div>
