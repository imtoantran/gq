...
<article class="main" style="margin-bottom:-1px;">
    ...
    <div class="left_banner">
        ...
        <div class="text_left_menu" style="background:#fff;height:631px">
            ...
            <?php if ($_GET['muc'])
                $url = 'shoes.php?muc=' . $_GET['muc'] . '&gia=';
            else
                $url = '?gia='
                ?>
            ...
            <div style="margin-left:2px;">
                ...
                <?php
                $color = array("52,52,52", "202,174,152", "181,149,85", "144,93,46", "29,97,83", "241,118,42", "156,130,113", "237,0,140", "235,38,41", "147,73,170 ", "52,90,255", "226,226,226", "204,155,40", "76,63,54", "37,105,158");
        ...
        <section id="show_sp">
            ...
            <div class="shoes" style="width:840px;">
                ...
                if ($_GET['gia']) {
                    ...
                    if ($_GET['gia'] == 2)
                        $dongia_seach = ">= 300000 AND `dongia` < 500000";

                    if ($_GET['gia'] == 3)
                        $dongia_seach = ">= 500000 AND `dongia` < 1000000";

                    if ($_GET['gia'] == 4)
                        $dongia_seach = ">= 1000000 ";
                }
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    <div>
                        <a href="chitiet.php?item=sp-<?php echo $row['id'] ?>">
                            <img onerror="this.src='images/icon/error.jpg'" src="images/product/shoes/<?php echo $row['id'] ?>_1.jpg" alt="<?php echo $row['ten'] ?>" title='<?php echo $row['ten'] ?>'/>
        ...
        <section>
            ...
            <div class="shoes" style="width:840px;">
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    <a href="chitiet.php?item=sp-<?php echo $row['ma_sp'] ?>">
                        <div>
                            <img onerror="this.src='images/icon/error.jpg'"  src="images/product/shoes/<?php echo $row['ma_sp'] ?>_1.jpg" alt="" />
                        </div>
                    </a>
